  ...
  return (
    <div>
      ...
      <div className="project-card">
        ...
        <p>An online portal made for viewing jobs using Java and HTML.</p>
        <a href="https://github.com/akshara-parkibanda/Online-Job-Portal" target="_blank" rel="noreferrer">
          View on GitHub
        </a>
      </div>
